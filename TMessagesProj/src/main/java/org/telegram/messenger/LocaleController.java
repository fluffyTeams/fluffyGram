...
public class LocaleController {
    ...
    private String getStringInternal(String key, String fallback, int fallbackRes, int res) {
        if (key.equals("AppName")) {
            try {
                return ApplicationLoader.applicationContext.getString(R.string.fluffyGram);
            } catch (Exception e) {
                FileLog.e(e);
            }
        }
        if (key.equals("AppNameBeta")) {
            try {
                return ApplicationLoader.applicationContext.getString(R.string.fluffyGramBeta);
            } catch (Exception e) {
                FileLog.e(e);
            }
        }
